...
_ValidatorType2["default"].prototype.getResult = _circleCoreTypes2["default"].func([_circleCoreTypes2["default"].String], _Result2["default"], "validator.getResult").of(function (match) {
  return _Result2["default"].create(_RegExType2["default"].is(this.filter) ? (0, _lodash.first)(this.filter.exec(match)) : null);
});
...
_ValidatorType2["default"].create = _circleCoreTypes2["default"].func([_ConditionType2["default"]], _ValidatorType2["default"], "Validator.create").of(function (condition) {
  ...
  if (_RegExType2["default"].is(condition)) return (0, _lodash.assign)(validator, { validate: function validate(value) {
  ...
  if (_circleCoreTypes2["default"].Function.is(condition)) return (0, _lodash.assign)(validator, { validate: condition });
});
