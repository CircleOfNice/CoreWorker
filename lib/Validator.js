 ...
 * @return {Result}
 */
_ValidatorType2["default"].prototype.getResult = _tcomb2["default"].func([_tcomb2["default"].String], _Result2["default"], "validator.getResult").of(function (match) {
 ...
 * @return {Validator}
 */
_ValidatorType2["default"].create = _tcomb2["default"].func([_ConditionType2["default"]], _ValidatorType2["default"], "Validator.create").of(function (condition) {
