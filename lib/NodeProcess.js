 ...
 */
_NodeProcessType2["default"].prototype.lastOutput = _tcomb2["default"].func([], _tcomb2["default"].Object, "nodeProcess.lastOutput").of(function () {
 ...
 */
_NodeProcessType2["default"].prototype.run = _tcomb2["default"].func([], _tcomb2["default"].Nil, "nodeProcess.run").of(function () {
    var _this = this;
 ...
 */
_NodeProcessType2["default"].prototype.throwTimeoutError = _tcomb2["default"].func([_tcomb2["default"].Object], _tcomb2["default"].Nil, "nodeProcess.onTimeout").of(function (deferred) {
    var output = this.lastOutput();
    var errorMessage = _tcomb2["default"].Nil.is(output.lastOutput) ? "Timeout exceeded." : "Timeout exceeded. Last process output is: " + output.lastOutput;
