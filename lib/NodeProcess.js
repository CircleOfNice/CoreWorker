...
_NodeProcessType2["default"].prototype.kill = _circleCoreTypes2["default"].func([], _circleCoreTypes2["default"].Nil, "nodeProcess.kill").of(function () {
    ...
    var forceKill = setTimeout(function () {
        return (0, _child_process.exec)("for pid in $(ps --no-headers -fC \"" + _this2.command + "\" | awk '{print $2}'); do kill -15 $pid; done");
    }, 1000);

    this.emitter.on("death", function () {
