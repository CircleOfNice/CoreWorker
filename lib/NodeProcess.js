...
_NodeProcess2.default.prototype.run = function () {
    ...
    process.on("close", function (code, signal) {
        return _this.instance.exitCodes.indexOf(code) > -1 || _NotNil2.default.is(signal) ? _this.finish.call(_this, code) : _this.terminate.call(_this, code);
    });
 ...
 * @return {Promise}
 */
_NodeProcess2.default.prototype.kill = _tcomb2.default.func([_tcomb2.default.list(_tcomb2.default.Number)], _tcomb2.default.Object, "nodeProcess.kill").of(function (exitCodes) {
    var deferred = _q2.default.defer();
    var onNotRunning = function onNotRunning() {
 ...
 */
_NodeProcess2.default.prototype.finish = _tcomb2.default.func([_tcomb2.default.maybe(_tcomb2.default.Number)], _tcomb2.default.Nil, "nodeProcess.finish").of(function () {
    (0, _lodash.assign)(this.instance, { isRunning: false });
 ...
 */
_NodeProcess2.default.prototype.onDeath = _tcomb2.default.func([_tcomb2.default.Object, _ExitCodes2.default], _tcomb2.default.Nil, "nodeProcess.onDeath").of(function (deferred, exitCodes) {
    (0, _lodash.assign)(this.instance, { exitCodes: exitCodes });
...
_NodeProcess2.default.prototype.onTimeout = _tcomb2.default.func([_tcomb2.default.Object], _tcomb2.default.Nil, "nodeProcess.onTimeout").of(function (deferred) {
    ...
    this.emitter.on("timeout", function () {
        return deferred.reject(_TimeoutError2.default.create((0, _lodash.last)(_this3.instance.output)));
    });
});
...
_NodeProcess2.default.create = _tcomb2.default.func([_tcomb2.default.String, _Condition2.default], _NodeProcess2.default, "NodeProcess.create").of(function (command, condition) {
    ...
    return {
        ...
        filter: filter,
        instance: {
            exitCodes: _ExitCodes2.default.create(),
            isRunning: false,
            isStreaming: false,
            output: [],
            lastMatch: null,
