...
_NodeProcessType2["default"].prototype.run = _circleCoreTypes2["default"].func([], _circleCoreTypes2["default"].Nil, "NodeProcess.run").of(function () {
    ...
    process.on("close", (function (code) {
        ...
        return code === 0 ? this.emitter.emit("death", _Result2["default"].create(this.instance.output.join(""))) : this.emitter.emit("failure", new Error("Process closed with Error Code " + code));
    }).bind(this));
 ...
 */
_NodeProcessType2["default"].prototype.onDeath = _circleCoreTypes2["default"].func([_circleCoreTypes2["default"].Object], _circleCoreTypes2["default"].Nil, "nodeProcess.onDeath").of(function (cb) {
