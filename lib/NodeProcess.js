...
_NodeProcessType2["default"].prototype.run = _circleCoreTypes2["default"].func([], _circleCoreTypes2["default"].Nil, "NodeProcess.run").of(function () {
    ...
    process.on("close", function (code, signal) {
        return code === 0 || _circleCoreTypes2["default"].NotNil.is(signal) ? _this.finish.call(_this) : _this.terminate.call(_this, code);
    });
 ...
 */
_NodeProcessType2["default"].prototype.startStream = _circleCoreTypes2["default"].func([], _circleCoreTypes2["default"].Nil, "nodeProcess.startStream").of(function () {
    (0, _lodash.assign)(this.instance, {
        isStreaming: true
    });
});
 ...
 */
_NodeProcessType2["default"].prototype.kill = _circleCoreTypes2["default"].func([], _circleCoreTypes2["default"].union([_circleCoreTypes2["default"].Boolean, _circleCoreTypes2["default"].Object]), "nodeProcess.kill").of(function () {
 ...
 */
_NodeProcessType2["default"].prototype.terminate = _circleCoreTypes2["default"].func([_circleCoreTypes2["default"].Index], _circleCoreTypes2["default"].Nil, "nodeProcess.terminate").of(function (code) {
 ...
 */
_NodeProcessType2["default"].prototype.finish = _circleCoreTypes2["default"].func([], _circleCoreTypes2["default"].Nil, "nodeProcess.finish").of(function () {
    (0, _lodash.assign)(this.instance, { isRunning: false });
 ...
 */
_NodeProcessType2["default"].prototype.onDeath = _circleCoreTypes2["default"].func([_circleCoreTypes2["default"].Object], _circleCoreTypes2["default"].Nil, "nodeProcess.onDeath").of(function (deferred) {
