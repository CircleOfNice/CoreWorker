...
describe("CoreWorker", function () {
    //eslint-disable-line
    it("executes an application and waits until it is ready", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        var counter, result;
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 11:
                        _context.t1 = _context.sent.data.split("\n");
                        _context.t2 = ["Log No. 1", "Log No. 2", "Log No. 3", "Log No. 4", "Log No. 5", "Log No. 6", "Log No. 7", "Log No. 8", "Log No. 9", "Log No. 10"];
    ...
    it("executes an application and waits until it is ready", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
        var counter, result;
    ...
    it("executes an application and waits its death", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
        var counter, result;
    ...
    it("executes an application and waits its death with a spedified timeout", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
        var counter, result;
    ...
    it("executes an application, awaits its death and terminates with valid exit code", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5() {
    ...
    it("executes an application, kills it and terminates with valid exit code", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6() {
    ...
    it("starts a selenium server and kills it", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7() {
        var command, condition, seleniumProcess, result;
        return _regenerator2.default.wrap(function _callee7$(_context7) {
            while (1) {
                switch (_context7.prev = _context7.next) {
                    case 0:
                        command = "java -jar " + _seleniumServerStandaloneJar2.default.path + " -port 51515";
                        condition = /Selenium Server is up and running/;
                        seleniumProcess = (0, _index.process)(command, condition);
                        _context7.next = 5;
                        return seleniumProcess.ready(5000);

                    case 5:
                        _context7.next = 7;
                        return seleniumProcess.kill(143);

                    case 7:
                        result = _context7.sent;


                        _assert2.default.equal(result.data.split("\n").pop().split("-").pop().trim(), "Selenium Server is up and running");
