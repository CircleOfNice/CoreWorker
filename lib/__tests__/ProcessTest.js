...
var restoreAndSet = function restoreAndSet(toRestore, toSet, functionName, stubFunction) {
    toRestore.restore();
    _sinon2.default.stub(toSet, functionName).callsFake(stubFunction);
};

describe("Process", function () {
    before(function () {
        _sinon2.default.stub(_NodeProcess2.default.prototype, "run").callsFake(run);
        _sinon2.default.stub(_NodeProcess2.default.prototype, "write").callsFake(write);
        _sinon2.default.stub(_NodeProcess2.default.prototype, "onReady").callsFake(onReady);
        _sinon2.default.stub(_NodeProcess2.default.prototype, "onDeath").callsFake(onDeath);
        _sinon2.default.stub(_NodeProcess2.default.prototype, "kill").callsFake(kill);
    ...
    it("runs a new Instance and returns a stream", function () {
        ...
        var streamSpy = new _stream.Writable({
            // eslint-disable-line
            write: function write(data, enc, next) {
                pipeSpy(data);
                next();
            }
        });
