...
var onStatusChange = function onStatusChange(resolve) {
    test.set({
...
describe("Process", function () {
    before(function () {
        ...
        _sinon2["default"].stub(_NodeProcess2["default"].prototype, "onReady", onStatusChange);
        _sinon2["default"].stub(_NodeProcess2["default"].prototype, "onDeath", onStatusChange);
    ...
    it("runs a new Instance and waits until death", function (done) {
        ...
        instance.death().then(function (data) {
            _assert2["default"].equal(data, "TestString", "TestString should be resolved");
            done();
        })["catch"](done);
    ...
    it("runs a new Instance and returns a stream", function () {
        ...
        (0, _assert2["default"])(pipeSpy.calledWith("Test2"), "pipeSpy was called with wrong args: \n " + pipeSpy.lastCall.args);

        _assert2["default"].throws(process.stream, Error, "It should only run one instance");
    });
});
