...
describe("CoreExec", function () {
    it("executes an application and waits until it is ready", function callee$1$0(done) {
        ...
        return _regeneratorRuntime.async(function callee$1$0$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
                case 0:
                    counter = (0, _index2["default"])("node " + counterScript, "Log No. 10");
                    context$2$0.prev = 1;
                    context$2$0.next = 4;
    ...
    it("executes an application and waits until it is ready", function callee$1$0(done) {
        ...
        return _regeneratorRuntime.async(function callee$1$0$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
                case 0:
                    counter = (0, _index2["default"])("node " + counterScript, /Log\ No\.\ 5/);
                    context$2$0.prev = 1;
                    context$2$0.next = 4;
                    return _regeneratorRuntime.awrap(counter.ready(500));
    ...
    it("executes an application and handles it as a stream", function (done) {
        var inputLogger = (0, _index2["default"])("node " + stdinLogger, "");
