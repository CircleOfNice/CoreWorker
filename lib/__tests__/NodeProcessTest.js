...
describe("NodeProcess", function () {
    before(function () {
        _sinon2.default.stub(_child_process2.default, "spawn").callsFake(spawn);
    });
    ...
    it("creates a new nodeProcess", function () {
        ...
        _assert2.default.deepStrictEqual((0, _lodash.keys)(nodeProcess.instance), ["exitCodes", "isRunning", "isStreaming", "output", "lastMatch", "fulfilled"], "No Instance of child_process should be set");
    ...
    it("starts a nodeProcess and waits until it is closed", function () {
        ...
        callbacks.close(1);
        _assert2.default.deepStrictEqual(mockPromise.reject.getCall(0).args, [new Error("Error: Process was closed unexpectedly. Code: 1")]);
    });
});
