...
var run = _circleCoreTypes2["default"].func([], _circleCoreTypes2["default"].Nil, "NodeProcess.run").of(function () {
    ...
    var process = spawn(this.command, this.commandArgs);
    ...
    process.on("close", function () {
        return _this.emitter.emit("death", _Result2["default"].createBatch(_this.instance.output)) && (0, _lodash.assign)(_this.instance, { isRunning: false });
    });
...
var kill = _circleCoreTypes2["default"].func([], _circleCoreTypes2["default"].Nil, "nodeProcess.kill").of(function () {
    if (!this.isRunning()) return;
