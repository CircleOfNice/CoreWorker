 ...
 * @return {Promise}
 */
_Process2.default.prototype.death = function (maybeTimeout, maybeExitCodes) {
  var timeout = _tcomb2.default.Number((0, _setDefaultValue2.default)(maybeTimeout).to(0));
  var exitCodes = _ExitCodes2.default.create(maybeExitCodes);
 ...
 * @param {MaybeExitCodes} maybeExitCodes that are valid
 */
_Process2.default.prototype.kill = _tcomb2.default.func([_MaybeExitCodes2.default], _tcomb2.default.Object, "process.kill").of(function (maybeExitCodes) {
  var exitCodes = _ExitCodes2.default.create(maybeExitCodes);
