...
_ProcessType2["default"].prototype.death = function (maybeTimeout) {
  ...
  this.instance.run();
  setTimeout(function () {
    return timeout === 0 ? null : deferred.reject(_TimeoutError2["default"].create((0, _lodash.last)(_this.instance.instance.output)));
  }, timeout);
...
_ProcessType2["default"].prototype.ready = _tcomb2["default"].func([_tcomb2["default"].Number], _tcomb2["default"].Object, "process.ready").of(function (timeout) {
  ...
  this.instance.run();
  setTimeout(function () {
    return deferred.reject(_TimeoutError2["default"].create((0, _lodash.last)(_this2.instance.instance.output)));
  }, timeout);
