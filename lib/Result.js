 ...
 * @return {Result}
 */
_ResultType2["default"].createBatch = _circleCoreTypes2["default"].func([_circleCoreTypes2["default"].list(_circleCoreTypes2["default"].String)], _ResultType2["default"], "Result.createBatch").of(function (output) {
    return {
        data: output.join("")
    };
});
